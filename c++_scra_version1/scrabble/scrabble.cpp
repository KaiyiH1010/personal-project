...
/*
TODO:
  cycle through players and execute their moves until game over

NOTE:
 - move kind can only be pass, exchange or place
*/
void Scrabble::game_loop() {
  ...
  while (cont) {
    ...
    // update loop variable and check if game should end
...
/*
TODO:
  subtract players' final score after game ended: 
  they lose points for each tile in their hand
  the player who cleared their hand receives all points lost by others
*/
