...
// TEST_F(PlaceTest, personal_test_on_last_col_firstmove) {
// 	Board b = Board::read("config/board0.txt");
...
// TEST_F(PlaceTest, personal_test_on_last_col_multiplemove) {
// 	Board b = Board::read("config/board0.txt");
...
// 	vector<TileKind> k;
// 	k.push_back(TileKind('I', 1));
// 	k.push_back(TileKind('R', 1));
// 	k.push_back(TileKind('T', 1));
// 	k.push_back(TileKind('H', 1));
// 	k.push_back(TileKind('D', 1));
// 	k.push_back(TileKind('A', 1));
// 	k.push_back(TileKind('Y', 1));
// 	Move m2 = Move(k, 8, 7, Direction::DOWN);
// 	PlaceResult result = b.place(m2);
// 	EXPECT_TRUE(result.valid);
// }